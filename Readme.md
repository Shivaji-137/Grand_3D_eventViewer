## This is the sample 3D Event Viewer in javascript for Giant Radio Array for Neutrino Detection, written by Shivaji Chaulagain
...
### * Note: If running locally, all this file should be together to works.
